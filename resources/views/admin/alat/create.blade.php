<x-layouts.dashboard title="Tambah Alat">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden max-w-2xl">
        <form method="POST" action="{{ route('admin.alat.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input name="nama_alat" value="{{ old('nama_alat') }}" placeholder="Masukkan nama alat" class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all">
                ...
                <div>
                    ...
                    <input name="stok" type="number" min="0" value="{{ old('stok', 0) }}" placeholder="Jumlah stok" class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all">
                ...
                <!-- Foto -->
                <div class="sm:col-span-2">
                    <label class="block text-sm font-medium text-slate-700 mb-2">Foto Alat <span class="text-slate-400 font-normal">(Opsional)</span></label>
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-slate-100">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-xl px-5 py-2.5 transition-colors">Simpan Alat</button>
